...
if (isset($_POST['personal'])) {
  ...
  $stmt = $con->prepare("UPDATE cv SET fname=?, lname=?, dob=?, phone=?, gender=?, image=?, address=? WHERE idcv=?");
  $stmt->bind_param("sssssssi", $fname, $lname, $dob, $phone, $gender, $photoPath, $address, $idcv); // Assuming $idcv is the user's ID
  $stmt->execute();
  $stmt->close();
...
<body class="g-sidenav-show bg-gray-200">
              ...
              <ul class="nav nav-pills nav-fill p-1" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                    ...
                    <span class="ms-1">Qulification</span>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <div class="card-body p-3">
                  <form role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="personal">Sign
                        Up</button>
                    </div>
                  </form>
                </div>
            ...
            <div class="col-12 mt-4">
              ...
              <div class="row">
                <form role="form" method="POST">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="qulifi">Sign
                      Up</button>
                  </div>
                </form>
              </div>
            ...
            <div class="col-12 mt-4">
              ...
              <div class="row">
                <form role="form" method="POST">
                    ...
                    ?>
                        <div class="swrap">
                          ...
                          <div class="input-group input-group-outline mb-3">
                            ...
                            <input type="text" name="level[]" class="form-control" value="<?php echo $srow['level']; ?>">
                          </div>
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="skills">Sign
                      Up</button>
                  </div>
                </form>
              </div>
            ...
            <div class="col-12 mt-4">
              ...
              <div class="row">
                <form role="form" method="POST">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="exp">Sign
                      Up</button>
                  </div>
                </form>
              </div>
  ...
  <script>
    jQuery(document).ready(function($) {
      ...
      //   $(this).parent('.input-group').removeClass('focused is-focused');
      // });
